...
//            client cl= new client(driver,"http://192.168.1.20/opendev/pcmedics","admin","pass");
           ...
           PatientData pat = new PatientData("Test","Fees","1980-02-04","Female");
           pat.set_mothers_name("MothersName");
           taskDriver.createPatient(pat,true);
           taskDriver.newEncounter("Fee Sheet Encounter", "5 Administrative",false);
           taskDriver.gotoFeeSheet();

           taskDriver.feeSheetMultiCategory("Non-SRH - Family Health");
